...
이 프로젝트는 “사람이 많으면 먼지가 많을 것이다”라는 직관적 가설을 그대로 받아들이지 않고, 실제 데이터에서 예외 사례를 찾은 뒤 대안 가설을 설정하고 통계 검정으로 판단한 경험입니다.

정책적 관점에서도 단순한 인원 통제보다 **환기 시스템 개선, 터널·승강장 공기질 관리, 운행 빈도와 역사 구조를 고려한 PM10 저감 전략**이 중요할 수 있음을 시사합니다.

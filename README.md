...
## 2.2 내부 vs 외부 미세먼지 비교

발표자료의 첫 번째 관찰은 **지하철 역사 내부 미세먼지와 외부 미세먼지의 시간대별 패턴 비교**였습니다. 내부 미세먼지가 외부와 다른 시간대 패턴을 보였고, 이를 통해 역사 내부 요인이 PM10 증가에 관여할 가능성을 검토했습니다.

이 repo에서는 공개된 `data2.csv`를 기준으로 노선별 역사 PM10 분포를 먼저 정리했습니다.
